...
int main() {
  ...
  struct Figure.cont c1; init_spec(Figure.cont, &c1);
  FigureContainerInit(&c1);

  struct Figure.rect r1; init_spec(Figure.rect, &r1);
    r1.@.x = 3; r1.@.y = 10;
  struct Figure.trian t1; init_spec(Figure.trian, &t1);
    t1.@.a = 3; t1.@.b = 4; t1.@.c = 5;
  struct Figure.rect r2; init_spec(Figure.rect, &r2);
    r2.@.x = 13; r2.@.y = 20;
  ...
  struct Figure.cont c2; init_spec(Figure.cont, &c2);
  FigureContainerInit(&c2);
  FigureContainerAppend(&c1, (Figure*)&c2);

  struct Figure.rect r3; init_spec(Figure.rect, &r3);
    r3.@.x = 13; r3.@.y = 110;
  struct Figure.trian t2; init_spec(Figure.trian, &t2);
    t2.@.a = 13; t2.@.b = 14; t2.@.c = 15;
  struct Figure.rect r4; init_spec(Figure.rect, &r4);
    r4.@.x = 113; r4.@.y = 120;
  FigureContainerAppend(&c2, (Figure*)&r3);
  FigureContainerAppend(&c2, (Figure*)&t2);
  FigureContainerAppend(&c1, (Figure*)&r4);

  struct Figure.rect r5; init_spec(Figure.rect, &r5);
    r5.@.x = 23; r5.@.y = 210;
  struct Figure.trian t3; init_spec(Figure.trian, &t3);
    t3.@.a = 23; t3.@.b = 24; t3.@.c = 25;
  struct Figure.rect r6; init_spec(Figure.rect, &r6);
    r6.@.x = 213; r6.@.y = 220;
  FigureContainerAppend(&c1, (Figure*)&r5);
  FigureContainerAppend(&c1, (Figure*)&t3);
  FigureContainerAppend(&c1, (Figure*)&r6);

  struct Figure.rect r7; init_spec(Figure.rect, &r7);
    r7.@.x = 333; r7.@.y = 3210;
  struct Figure.trian t4; init_spec(Figure.trian, &t4);
    t4.@.a = 323; t4.@.b = 324; t4.@.c = 325;
  struct Figure.rect r8; init_spec(Figure.rect, &r8);
    r8.@.x = 3213; r8.@.y = 3220;
